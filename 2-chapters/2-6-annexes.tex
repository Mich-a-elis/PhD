...
\vspace{0.2cm}
1.\quad Marquer tous les triangle à 0\\[0.2cm]
2.\quad Soit M=1\\[0.2cm]
\Tq{tous les triangles ne sont pas marqués}{
\vspace{0.2cm}
3.\quad Soit $V$ une liste vide\\[0.2cm]
4.\quad Stocker dans $V$ un triangle non marqué\\[0.2cm]
5.\quad Marqué le triangle Stocké avec M\\[0.2cm]
\Tq{$V$ n'est pas vide}{
\vspace{0.2cm}
6.\quad Soit $C=V$\\[0.2cm]
7.\quad Vider $V$\\[0.2cm]
...
\vspace{0.2cm}
8.\quad Stocker dans $V$ un triangle voisin\\[0.2cm]
9.\quad Marqué le triangle Stocké avec M\\[0.2cm]
}
\vspace{0.2cm}
}
\vspace{0.2cm}
...
Nous présentons ici un algorithme permettant d'identifier les parties connexe d'un maillage en marquant (colorier) les triangles appartenant a un meme partie connexe.
