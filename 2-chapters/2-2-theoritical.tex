...
\begin{itemize}
 ...
 \begin{equation}
    ...
    \theta_{\bar{u}}^\gamma(1)-\theta_{\bar{u}}^\gamma(0)=\chi(\Omega)-\sum_{p\in\mathcal{B}}I_p.
\end{equation}
\end{itemize}
