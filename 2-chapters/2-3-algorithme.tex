...
Dans cette partie, nous présentons quelque méthodes de génération de champ de croix que l'on rencontre dans la littérature et que nous avons utilisé dans notre travail.
\[\]
edp\\

z-ai\\
cette formule permet de créer dans le plan des champ de croix ayant des points singuliers avec des indices définies\\
somme flux triangle
