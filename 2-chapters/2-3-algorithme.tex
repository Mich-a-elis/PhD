...
$$
%\\[-0.2cm]
\item[$\bullet$] si $p\in T$ où $T$ est un triangle de $\Omega_h$ non-singulier, alors on pose :%\\[-0.3cm]
$$
\left\{
\begin{array}{l}
...
\begin{remark}
 Sur la pertinence des restrictions sur le maillage trianglulaire.
\end{remark}
